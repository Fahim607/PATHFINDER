...
if(isset($_POST["Apply"]))
{
  ...
  $move = "upload/cv/".$filename;
move_uploaded_file($_FILES["uploadresume"]["tmp_name"], $move);
	/* move_uploaded_file($_FILES["uploadresume"]["tmp_name"],"C:\Users\HP\OneDrive\Pictures\Documents\Applied CV".$filename);*/
	$date = date("Y-m-d");
