	 ...
	 <div class="form-group">
        ...
        <div class="col-sm-6">
        	<select class="form-control" name="semester" id="semester" >
				...
				<?php
				$arr = array("1st Trimester","2nd Trimester","3rd Trimester","4th Trimester","5th Trimester","6th Trimester","7th Trimester","8th Trimester", "9th Trimester", "10th Trimester", "11th Trimester", "12th Trimester");
				foreach($arr as $val)
				{
					echo "<option value='$val'>$val</option>";
				}
