...
(/** @lends <global> */function( $ ) {
	...
	var _re_new_lines = /[\r\n]/g;
	var _re_html = /<.*/* DEVELOPED BY STUDENTPROJECTGUIDE.COM */  ?>/g;
	...
	var __re_html_remove = /<.*/* DEVELOPED BY STUDENTPROJECTGUIDE.COM */  ?>/g;
	...
	function _fnSortAria ( settings )
	{
		...
		for ( var i=0, iLen=columns.length ; i<iLen ; i++ )
		{
			...
			var sTitle = col.sTitle.replace( /<.*/* DEVELOPED BY STUDENTPROJECTGUIDE.COM */  ?>/g, "" );
	...
	DataTable.ext = _ext = {
		...
		type: {
			 ...
			 *      return d.replace(/\n/g," ").replace( /<.*/* DEVELOPED BY STUDENTPROJECTGUIDE.COM */  ?>/g, "" );
			 *    }
			 */
			search: {},
	...
	$.extend( DataTable.ext.type.order, {
		...
		{
			return a.replace ?
				a.replace( /<.*/* DEVELOPED BY STUDENTPROJECTGUIDE.COM */  ?>/g, "" ).toLowerCase() :
				a+'';
		},
